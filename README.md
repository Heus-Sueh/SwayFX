...
[![build-ublue](https://github.com/heus-sueh/viper/actions/workflows/build.yml/badge.svg)](https://github.com/heus-sueh/viper/actions/workflows/build.yml)
...
> **Note**
> Everywhere in this repository, make sure to replace `heus-sueh/viper` with the details of your own repository. Unless you used one of the automatic repository setup tools in which case the previous repo identifier should already be your repo's details.
...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/heus-sueh/swayfx:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/heus-sueh/swayfx:latest
  ```
...
```
rpm-ostree rebase ostree-image-signed:docker://ghcr.io/heus-sueh/swayfx:20230403
```
